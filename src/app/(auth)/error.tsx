...
export default function AuthError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 text-center" role="alert">
      ...
      <p className="mt-2 text-sm text-muted-foreground">Please try again or go back to login.</p>
      <div className="mt-6 flex gap-4">
        ...
        <Button size="sm" variant="outline" asChild>
          <Link href={ROUTES.login} className="focus-visible:ring-2 focus-visible:ring-[#C4A747] focus-visible:ring-offset-2">
            Back to login
          </Link>
        </Button>
      </div>
